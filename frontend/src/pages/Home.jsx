        ...
        <Container>
          <Row>
            <Col lg="3">
              ...
              <h2 className="services__title">We offer are best services</h2>
            </Col>
            <ServiceList />
          </Row>
        </Container>
          ...
          <Row>
            <Col lg="6">
              <div className="experience__content">
                ...
                <p>
                Your travel aspirations are our priority.
                  <br />
                We're committed to making your experience seamless and rewarding.
                </p>
              </div>
      ...
      <section>
        <Container>
          <Row>
            ...
            <h2 className="testimonial__title">What our fan's say about us.</h2>
            </Col>
            <Col lg="12">
              <Testimonials />
            </Col>
